    ...
    public partial class Form2 : Form
    {
        ...
        public async Task tcpCommandAsync(string command, TcpClient client)
        {
            try
            {
                ...
                string message = command + "-" + this.machineIP;
                //convert to bytes 
        ...
        public void writeLog(string comType, string eventInfo)
        {
            try
            {
                if (!eventInfo.Equals("")) 
                {
                    string filePath = "C:\\Users\\samue\\OneDrive\\Desktop\\ASPNET\\TCPClient Machine2\\logs\\MID" + this.machineID + "_LogFile_" + DateTime.Now.ToString("dd-MM-yyyy") + ".txt";
        ...
        private DataTable ConvertStringArrayToDataTable(string[] dataArray, string dtType)
        {
            ...
            if (dtType.Equals("activityLogs"))
            {
                ...
                dataTable.Columns.Add("LogClientIP");
                dataTable.Columns.Add("LogComType");
                dataTable.Columns.Add("LogEventInfo");
        ...
        {
            //this.addLogs("asdasd", wcf_service.StopTcp());
        }
    }
}
